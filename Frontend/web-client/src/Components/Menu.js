            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <NavLink exact active className="active nav-link btn btn-primary text-white" to="/washingAssistant">WashingAssistant</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink exact active className="active nav-link" to="#"></NavLink>
                        </li>
                        ...
                        <li className="nav-item">
                            <NavLink exact active className="active nav-link btn btn-primary text-white" to="/AddBooking">addBooking</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink exact active className="active nav-link" to="#"></NavLink>
                        </li>
